            ...
            >
                ...
                <Modal.Body style={{width: "100%", height: "auto", textAlign: "center", padding: "0", marginTop: ".8em"}}>
                    <div style={{width: "100%", height: "4%", paddingLeft: "1.1em", paddingRight: "1.1em"}}>
                        <p id="p-cancelar-plano-mensal"> 
                                                         {(this.props.tipoPlano === "doador") ? "Deseja realmente cancelar sua assinatura no plano " + this.props.plano.planoMensal.nomePlano :
                                                         "Deseja realmente inativar o plano " + this.props.plano.nomePlano}?</p>
                    </div>
